...
interface MBburgerProps {
  ...
  interface friendsList{
	...
	const [state, setState] = useState<friendsList[]>(null);
	...
	return (
		...
		<div className="h-screen border w-[112px] flex justify-center">
			...
			<svg width="20px" height="20px" viewBox="-0.5 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
				<path d="M22 11.8201C22 9.84228 21.4135 7.90885 20.3147 6.26436C19.2159 4.61987 17.6542 3.33813 15.8269 2.58126C13.9996 1.82438 11.9889 1.62637 10.0491 2.01223C8.10927 2.39808 6.32748 3.35052 4.92896 4.74904C3.53043 6.14757 2.578 7.92935 2.19214 9.86916C1.80629 11.809 2.00436 13.8197 2.76123 15.6469C3.51811 17.4742 4.79985 19.036 6.44434 20.1348C8.08883 21.2336 10.0222 21.8201 12 21.8201" stroke={strokeColor.img2} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
				<path d="M2 11.8201H22" stroke={strokeColor.img2} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
				<path d="M12 21.8201C10.07 21.8201 8.5 17.3401 8.5 11.8201C8.5 6.30007 10.07 1.82007 12 1.82007C13.93 1.82007 15.5 6.30007 15.5 11.8201" stroke={strokeColor.img2} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
				<path d="M18.3691 21.6901C20.3021 21.6901 21.8691 20.1231 21.8691 18.1901C21.8691 16.2571 20.3021 14.6901 18.3691 14.6901C16.4361 14.6901 14.8691 16.2571 14.8691 18.1901C14.8691 20.1231 16.4361 21.6901 18.3691 21.6901Z" stroke={strokeColor.img2} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
				<path d="M22.9998 22.8202L20.8398 20.6702" stroke={strokeColor.img2} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
			</svg>
				</button>
			...
			<NavLink to="/Chat">
				...
				<svg width="20" height="20" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
					<g id="Chat">
					<path id="Path" fillRule="evenodd" clipRule="evenodd" d="M11.0568 1.00008C7.54687 0.985898 4.28557 2.80704 2.4605 5.80035C0.635434 8.79366 0.512919 12.5223 2.13757 15.6286L2.33789 16.0191C2.50209 16.3264 2.53644 16.6864 2.43329 17.0191C2.14742 17.7784 1.90849 18.5544 1.71784 19.3429C1.71784 19.7429 1.83231 19.9715 2.26158 19.962C3.0219 19.7941 3.77068 19.5777 4.50332 19.3143C4.81886 19.2274 5.15437 19.2475 5.45725 19.3715C5.73389 19.5048 6.2967 19.8477 6.31578 19.8477C9.99154 21.7804 14.4808 21.2472 17.5998 18.5074C20.7187 15.7676 21.8199 11.39 20.3676 7.50403C18.9153 3.61809 15.2111 1.03053 11.0568 1.00008V1.00008Z" stroke={strokeColor.img3} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
					<ellipse id="Oval" cx="6.28751" cy="11.0001" rx="0.476965" ry="0.47619" stroke={strokeColor.img3} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
					<ellipse id="Oval_2" cx="11.057" cyerror="11.0001" rx="0.476965" ry="0.47619" stroke={strokeColor.img3} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
					<ellipse id="Oval_3" cx="15.8266" cy="11.0001" rx="0.476965" ry="0.47619" stroke={strokeColor.img3} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
					</g>
					</svg>
				</button>
				</NavLink>
				...
				<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<g id="Game">
					<path id="Stroke 1" d="M8.84819 12.314V16.059" 	stroke={strokeColor.img4} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
					<path id="Stroke 2" d="M10.7586 14.1868H6.9375"  stroke={strokeColor.img4} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
					<path id="Stroke 3" d="M15.3665 12.428H15.2595"  stroke={strokeColor.img4} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
					<path id="Stroke 4" d="M17.18 16.0027H17.073"  stroke={strokeColor.img4} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
					<path id="Stroke 5" opacity="0.4" d="M8.07227 2V2C8.07227 2.74048 8.68475 3.34076 9.44029 3.34076H10.4968C11.6624 3.34492 12.6065 4.27026 12.6118 5.41266V6.08771"  stroke={strokeColor.img4} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
					<path id="Stroke 7" fillRule="evenodd" clipRule="evenodd" d="M16.4283 21.9625C13.4231 22.0134 10.473 22.0113 7.57275 21.9625C4.3535 21.9625 2 19.6663 2 16.5112V11.8616C2 8.70651 4.3535 6.41029 7.57275 6.41029C10.4889 6.36044 13.4411 6.36148 16.4283 6.41029C19.6476 6.41029 22 8.70755 22 11.8616V16.5112C22 19.6663 19.6476 21.9625 16.4283 21.9625Z"  stroke={strokeColor.img4} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
					</g>
					</g>
				</svg>
				</button>
