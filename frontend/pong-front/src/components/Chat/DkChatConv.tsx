...
export function DkChatConv ({prop_room , members ,profile, Old_Messages}: DkChatConvProps) {
	// console.log('dd');
	...
	const memoizedRef = useMemo(() => new_messages, [new_messages, Old_Messages]);
		  ...
		  <div className="pl-16	 z px-8 h-[90vh] sm:hidden mobile-nav-bar lg:block">
			<div className="w-full h-full flex flex-col justify-around">
			  ...
			  <div className="text-white text-xl">
				...
				{memoizedRef.current ? memoizedRef.current.map((message, index) => {
